<?php
  ...
  */
  ...
  $receiving_email_address = 'amriyasirli62@gmail.com';

  if( file_exists($php_email_form = base_url('assets/templates/').'assets/vendor/php-email-form/php-email-form.php' )) {
